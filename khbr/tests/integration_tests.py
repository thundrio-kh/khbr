...
def test_seedgen_boss_and_enemy_one_to_one():
...
def test_seedgen_enemy_one_to_one_pc():
    options = {"enemy": "One to One"}
    randomization = testutils.generateSeed(options)
...
def test_seedgen_boss_one_to_one():
    options = {"boss": "One to One"}
    randomization = testutils.generateSeed(options)
...
def test_seedgen_boss_one_to_one_pc():
    options = {"boss": "One to One"}
    randomization = testutils.generateSeed(options)
    options["memory_expansion"] = True
    randomization_pc = testutils.generateSeed(options)
...
def test_seedgen_boss_wild_cups():
...
def test_seedgen_boss_wild_datas():
...
def test_seedgen_boss_wild_cups_datas():
...
def test_seedgen_boss_wild_nightmare():
...
def test_is_replacement_blocked():
    kh2 = KingdomHearts2()
...
def test_dont_replace_enemy_msns_for_boss():
...
def test_gr_room_uses_luxord_msn_when_replaced():
...
def test_source_replace_allowed():
    pass

def test_msn_replace_allowed():
    pass
...
def test_isnightmare():
    pass

def test_child_inherits_parent():
    pass

def test_child_overwrites_parent():
    pass

def test_variationof_inherits_parent():
    pass # including variationof childs

def test_variationof_overwrites_parent():
    pass # including variationof childs

def test_msn_required():
    pass

def test_msn_source_as():
    pass

def test_cmdmods():
    pass

def test_mickey_source():
    pass

def test_sizetag():
    pass

def test_roommaxsize_roomsize_roomsizemultiplier():
    pass
